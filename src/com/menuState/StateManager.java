...
import com.menuState.levels.LvlOne;
...
//		states = new ArrayList<State>();
	...
	private void loadState(int state) {
		switch (state) {
		case MENUSTATE:
			states[state] = new menu(this);
			return;
		case SELECTSTATE:
			states[state] = new selectLevel(this);
			return;
		case HELPSTATE:
			states[state] = new HelpState(this);
			return;
		case OPTIONSTATE:
			states[state] = new options(this);
			return;
		case LEVEL1STATE:
			states[state] = new LvlOne(this, 7, 7);
			return;
		case LEVEL2STATE:
